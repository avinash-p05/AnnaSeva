...
import com.techelites.annaseva.volunteer.VolunNotificationDetails
import okhttp3.*
...
class AcceptedFoodDonationsListings : Fragment(),AcceptedFoodAdapterNgo.OnRecipeClickListener {
    private lateinit var recyclerView: RecyclerView
    private lateinit var recipeAdapter: AcceptedFoodAdapterNgo
    ...
    override fun onCreateView(
        ...
        val view =
            inflater.inflate(R.layout.fragment_accepted_food_donations_listings, container, false)

        recyclerView = view.findViewById(R.id.recipeViewN3)
        recyclerView.layoutManager = LinearLayoutManager(context)
        recipeAdapter = AcceptedFoodAdapterNgo(ArrayList(), requireContext(), this)
        recyclerView.adapter = recipeAdapter

        progressBar = view.findViewById(R.id.progressBarN3)
    ...
    private fun loadRecipes() {
        ...
        val request = Request.Builder()
            .url("https://anna-seva-backend.onrender.com/ngo/acceptedDonations/${userId}") // Replace with your actual API URL
            .build()
