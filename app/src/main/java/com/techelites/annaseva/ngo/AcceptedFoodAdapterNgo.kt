...
class AcceptedFoodAdapterNgo(
    private var donations: ArrayList<FoodNgo>,
    private val context: Context,
    private val listener: OnRecipeClickListener
) : RecyclerView.Adapter<AcceptedFoodAdapterNgo.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.accepted_food_ngo, parent, false)
